ESP32 SKETCH FOR BIOMEDICAL MONITORING SYSTEM: 
...
const char* ssid = "SSN";  // Enter SSID here 
const char* password = "Ssn1!Som2@Sase3#";  //Enter Password here 
...
html += "<style>"; 
html += "body { background-color: #fff; font-family: sans-serif; color: 
#333333; font: 14px Helvetica, sans-serif box-sizing: border-box;}"; 
html += "#page { margin: 20px; background-color: #fff;}"; 
html += ".container { height: inherit; padding-bottom: 20px;}"; 
html += ".header { padding: 20px;}"; 
html += ".header h1 { padding-bottom: 0.3em; color: #008080; font-size: 45px; 
...
2px; text-align: left;}"; 
html += ".header h3 { font-weight: bold; font-family: Arial, 'sans-serif'; 
font-size: 17px; color: #b6b6b6; text-align: center;}"; 
html += ".box-full { padding: 20px; border 1px solid #ddd; border-radius: 
1em 1em 1em 1em; box-shadow: 1px 7px 7px 1px rgba(0,0,0,0.4); background: 
#fff; margin: 20px; width: 300px;}"; 
html += "@media (max-width: 494px) { #page { width: inherit; margin: 5px 
auto; } #content { padding: 1px;} .box-full { margin: 8px 8px 12px 8px; 
padding: 10px; width: inherit;; float: none; } }"; 
html += "@media (min-width: 494px) and (max-width: 980px) { #page { width: 
...
html += ".sensor-labels { font-size: 1rem; vertical-align: middle; padding
bottom: 15px;}"; 
html += ".units { font-size: 1.2rem;}"; 
html += "hr { height: 1px; color: #eee; background-color: #eee; border: 
none;}"; 
html += "</style>"; 
...
html += "<h1>Biomedical Monitoring System</h1>"; 
html += "</div>"; 
...
html += "</div>"; 
if (BPM > 60) { 
html += "<p id='more_beat' style='color:red;font-size:24px;font-weight:800' 
align='center'><i class='fas fa-triangle-exclamation'></i>The heart beat is 
more than 60 BPM!</p>"; 
} 
html += "</div>"; 
html += "</body>"; 
